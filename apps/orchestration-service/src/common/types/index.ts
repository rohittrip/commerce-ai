...
// User Context for session-based personalization
...
export const DEFAULT_TOOL_CACHE_CONFIG: Record<string, ToolCacheConfig> = {
  ...
  // Cart and checkout tools should NOT be cached (stateful operations)
  ...
  'commerce.checkout.create': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
  'commerce.checkout.update': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
  'commerce.checkout.get': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
  'commerce.checkout.complete': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
  'commerce.checkout.cancel': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
  // Product discovery tools can be cached
  'commerce.product.estimateShipping': { enabled: true, ttlSeconds: 600, cacheKeyPrefix: 'tool:ship' },
  'commerce.product.listVariants': { enabled: true, ttlSeconds: 3600, cacheKeyPrefix: 'tool:var' },
  'commerce.promotions.get': { enabled: true, ttlSeconds: 300, cacheKeyPrefix: 'tool:promo' },
  'commerce.promotions.validateCoupon': { enabled: false, ttlSeconds: 0, cacheKeyPrefix: '' },
};
